...
| --------------- | ------------------: | ------------: | ---------: |
| EfficientNet-B0 |          **96.33%** |    **95.67%** | **95.69%** |
| ResNet18        |              93.00% |        87.33% |     87.29% |
...
يوفر النظام نظاماً لإدارة المستخدمين يتضمن:
...
تحتوي على صور Dataset المستخدمة في المشروع.

---

## ⚠️ ملاحظات مهمة

هذا المشروع مخصص لأغراض **البحث الأكاديمي والتجريب**، ونتائج النموذج لا ينبغي اعتبارها بديلاً عن التشخيص الزراعي المتخصص.
...
هذا المشروع جزء من مشروع **ماجستير في علوم الحاسوب**، ويجمع بين:
